...
-- Việt: admin (GĐ kỹ thuật) | Tâm: leader (TP BIM) | Dũng: head (nhóm BIM)
-- Hương: head (nhóm TK) | Khoa: staff (KS BIM) | Linh: staff (KS TK)
INSERT INTO users (id, org_id, dept_id, center_id, full_name, email, role, job_title, is_active)
VALUES
  ('00e00000-0000-0000-0000-000000000001','a2a00000-0000-0000-0000-000000000001','de000000-0000-0000-0000-000000000001','ce000000-0000-0000-0000-000000000001','Nguyễn Quốc Việt','viet.nq@a2z.com.vn','admin',  'Giám đốc kỹ thuật', TRUE),
  ('00e00000-0000-0000-0000-000000000002','a2a00000-0000-0000-0000-000000000001','de000000-0000-0000-0000-000000000001','ce000000-0000-0000-0000-000000000001','Trần Minh Tâm',   'tam.tm@a2z.com.vn', 'leader', 'Trưởng phòng BIM',  TRUE),
  ('00e00000-0000-0000-0000-000000000003','a2a00000-0000-0000-0000-000000000001','de000000-0000-0000-0000-000000000001','ce000000-0000-0000-0000-000000000001','Lê Hoàng Dũng',   'dung.lh@a2z.com.vn','head',   'Nhóm trưởng BIM',   TRUE),
  ('00e00000-0000-0000-0000-000000000004','a2a00000-0000-0000-0000-000000000001','de000000-0000-0000-0000-000000000002','ce000000-0000-0000-0000-000000000001','Phạm Thị Hương',  'huong.pt@a2z.com.vn','head',  'Nhóm trưởng TK',    TRUE),
  ('00e00000-0000-0000-0000-000000000005','a2a00000-0000-0000-0000-000000000001','de000000-0000-0000-0000-000000000001','ce000000-0000-0000-0000-000000000001','Võ Đình Khoa',    'khoa.vd@a2z.com.vn','staff',  'Kỹ sư BIM',         TRUE),
  ('00e00000-0000-0000-0000-000000000006','a2a00000-0000-0000-0000-000000000001','de000000-0000-0000-0000-000000000002','ce000000-0000-0000-0000-000000000001','Đặng Ngọc Linh',  'linh.dn@a2z.com.vn','staff',  'Kỹ sư thiết kế',    TRUE)
ON CONFLICT (id) DO NOTHING;

-- Gán trưởng phòng cho từng phòng ban
UPDATE departments SET head_user_id = '00e00000-0000-0000-0000-000000000003'
  WHERE id = 'de000000-0000-0000-0000-000000000001';
UPDATE departments SET head_user_id = '00e00000-0000-0000-0000-000000000004'
  WHERE id = 'de000000-0000-0000-0000-000000000002';

-- Gán giám đốc trung tâm
UPDATE centers SET director_id = '00e00000-0000-0000-0000-000000000002'
...
VALUES (
  ...
  '00e00000-0000-0000-0000-000000000003', TRUE
) ON CONFLICT (id) DO NOTHING;
...
INSERT INTO project_members (project_id, user_id, role, is_active) VALUES
  ('bb000000-0000-0000-0000-000000000001','00e00000-0000-0000-0000-000000000002','manager', TRUE),
  ('bb000000-0000-0000-0000-000000000001','00e00000-0000-0000-0000-000000000003','leader',  TRUE),
  ('bb000000-0000-0000-0000-000000000001','00e00000-0000-0000-0000-000000000005','engineer',TRUE),
  ('bb000000-0000-0000-0000-000000000001','00e00000-0000-0000-0000-000000000006','engineer',TRUE)
ON CONFLICT (project_id, user_id) DO NOTHING;

-- Thành viên dự án TPBL
INSERT INTO project_members (project_id, user_id, role, is_active) VALUES
  ('bb000000-0000-0000-0000-000000000002','00e00000-0000-0000-0000-000000000001','manager', TRUE),
  ('bb000000-0000-0000-0000-000000000002','00e00000-0000-0000-0000-000000000004','leader',  TRUE),
  ('bb000000-0000-0000-0000-000000000002','00e00000-0000-0000-0000-000000000006','engineer',TRUE),
  ('bb000000-0000-0000-0000-000000000002','00e00000-0000-0000-0000-000000000003','reviewer',TRUE)
ON CONFLICT (project_id, user_id) DO NOTHING;
...
VALUES
  ...
  ('dd000000-0000-0000-0000-000000000001','a2a00000-0000-0000-0000-000000000001',
   ...
   '00e00000-0000-0000-0000-000000000002','2026-03-20 10:00:00+07','Mô hình chính xác, tiến độ tốt',
  ...
  ('dd000000-0000-0000-0000-000000000003','a2a00000-0000-0000-0000-000000000001',
   ...
   '00e00000-0000-0000-0000-000000000006','00e00000-0000-0000-0000-000000000004',
  ...
  ('dd000000-0000-0000-0000-000000000004','a2a00000-0000-0000-0000-000000000001',
   ...
   '00e00000-0000-0000-0000-000000000003','00e00000-0000-0000-0000-000000000002',
  ...
  ('dd000000-0000-0000-0000-000000000010','a2a00000-0000-0000-0000-000000000001',
   ...
   '00e00000-0000-0000-0000-000000000003','00e00000-0000-0000-0000-000000000001',
...
INSERT INTO task_comments (task_id, user_id, content, created_at) VALUES
  ('dd000000-0000-0000-0000-000000000001','00e00000-0000-0000-0000-000000000005','Đã hoàn thành mô hình địa hình, gửi anh review.','2026-03-18 16:00:00+07'),
  ('dd000000-0000-0000-0000-000000000001','00e00000-0000-0000-0000-000000000003','Mô hình tốt, merge vào model tổng hợp.','2026-03-19 09:00:00+07'),
  ('dd000000-0000-0000-0000-000000000002','00e00000-0000-0000-0000-000000000005','Đang mô hình dầm hộp tiết diện thay đổi, khá phức tạp.','2026-04-01 10:00:00+07'),
  ('dd000000-0000-0000-0000-000000000004','00e00000-0000-0000-0000-000000000003','Đang chờ kết quả thí nghiệm SPT hố khoan BH-03.','2026-03-28 08:00:00+07'),
  ('dd000000-0000-0000-0000-000000000004','00e00000-0000-0000-0000-000000000002','Cần đẩy nhanh tiến độ, báo cáo đã quá hạn.','2026-04-01 09:00:00+07'),
  ('dd000000-0000-0000-0000-000000000006','00e00000-0000-0000-0000-000000000006','Hoàn thành bình đồ, gửi chị Hương review.','2026-03-14 15:00:00+07'),
  ('dd000000-0000-0000-0000-000000000007','00e00000-0000-0000-0000-000000000006','Đã xong trắc dọc, đang làm trắc ngang điển hình.','2026-04-02 11:00:00+07'),
  ('dd000000-0000-0000-0000-000000000010','00e00000-0000-0000-0000-000000000003','Khó khăn do cần phối hợp với Sở TN&MT Lâm Đồng.','2026-03-20 14:00:00+07'),
